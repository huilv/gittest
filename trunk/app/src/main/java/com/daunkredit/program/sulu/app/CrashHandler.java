...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            Logger.e("CrashHandler.NameNotFoundException---> error occured when collect package info", e);
        }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        PermissionManager.formSend(mContext, ServiceGenerator.HARVESTER_URL, formCrashMsg(sb.toString()));
        return null;
    }
    ...
    private JSONObject formCrashMsg(String crashMsg) {
        ...
        try {
            ...
            CrashMsgEntity.put("protocolVersion", ProtocolVersion.V_1_0);
