...
public class CameraView extends FrameLayout {
    ...
    public CameraView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        //            mCameraImpl = new Camera2Impl(mCameraListener, mPreviewImpl);
        //        }else {
        ...
        //            @Override
        //            public void run() {
        //                mCameraImpl.setSuggestRect(new Size(CameraView.this.getMeasuredWidth(), CameraView.this.getMeasuredHeight()));
        //            }
        //        });
    ...
    private class CameraListenerMiddleWare extends CameraListener {
        ...
        public void onRecordStart() {
            super.onRecordStart();
            getCameraListener().onRecordStart();
        }

        @Override
        public void onRecordPause() {
            super.onRecordPause();
            getCameraListener().onRecordPause();
        }

        @Override
        public void onCameraError(final String message, final Exception e) {
            super.onCameraError(message, e);
            getCameraListener().onCameraError(message, e);
